...
# used in gen_conf_mod
def read_error(logfile, indfile):
    '''
    Verify that stereoisomers were enumerated for all molecules with unspecified stereochemistry
    '''
    ## Parse logfile to get indices of molecules with unspecified stereochemsitry
    problem_ind = []
    ...
    ## Save molecule indices as a set for easier operations
